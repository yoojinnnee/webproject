...
<div class="container">
	...
	<c:choose>
		...
		<c:otherwise>
			<p style="text-align: right; margin-top: 10px; margin-right: 10px;">
				...
				<a href="${pageContext.request.contextPath}/users/logout"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
	...
	<div class="center-container" style="margin-top: 150px; text-align:center;">
